...
class BaseMouseHook:
    ...
    def start_raw_hid_learning(self, duration_s=60):
        """Enable a short, read-only Raw HID capture window.

        Platform hooks that can receive Raw Input HID reports override this.
        The base method keeps the engine/backend call safe on macOS/Linux.
        """
        return False
