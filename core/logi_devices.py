...
class LogiDeviceSpec:
    ...
    # Some known devices (notably Logitech G-series onboard-profile mice) do
    # not expose REPROG_CONTROLS_V4. They can still be supported through the
    # OS-level mouse hook for buttons that are emitted as standard mouse
    # events, so absence of REPROG_CONTROLS_V4 should not make them disappear
    # from Mouser entirely.
    requires_reprog_controls: bool = True
