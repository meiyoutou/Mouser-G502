...
_CONFIG_BACKUP_TRANSLATION_PATCHES = {
    "en": {
        ...
        "scroll.config_backup_desc": "Use this for your personal shortcuts, profiles, actions ring, language, and other Mouser settings. This is separate from the GitHub app download zip.",
        "scroll.config_backup_steps": "Move or reinstall: on the old computer choose Export personal settings, save the Mouser-settings-*.zip file, then on the new computer choose Import personal settings and select that exported zip.",
        "scroll.config_export": "Export personal settings",
        "scroll.config_import": "Import personal settings",
        "scroll.config_open_folder": "Open local settings folder",
        "status.config_exported": "Personal settings exported: {path}. On another computer, import this Mouser-settings zip from Mouser.",
        ...
        "status.config_import_wrong_zip": "That zip is not a personal settings backup. Choose the Mouser-settings-*.zip exported from Mouser, not the GitHub app download.",
        "status.config_folder_missing": "Could not open settings folder",
        "dialog.export_config": "Export Mouser Personal Settings",
        "dialog.import_config": "Import Mouser Personal Settings",
        "dialog.config_backup_filter": "Mouser personal settings backup (*.zip);;Legacy JSON config (*.json)",
        "dialog.config_restore_filter": "Mouser personal settings backup (*.zip *.json)",
    },
    "zh_CN": {
        "scroll.config_backup": "\u914d\u7f6e\u5907\u4efd",
        "scroll.config_backup_desc": "用来备份你的快捷键、配置档、动作环、语言和其他个人设置。这个包和 GitHub 下载的程序 zip 不是一个东西。",
        "scroll.config_backup_steps": "换电脑/重装：旧电脑点“导出个人配置包”，保存 Mouser-settings-*.zip；新电脑点“导入个人配置包”，选择这个导出的 zip。",
        "scroll.config_export": "导出个人配置包",
        "scroll.config_import": "导入个人配置包",
        "scroll.config_open_folder": "打开本机配置文件夹",
        "status.config_exported": "个人配置包已导出：{path}。换电脑时，在新电脑的 Mouser 里导入这个 Mouser-settings zip。",
        "status.config_imported": "个人配置已导入，快捷键已恢复",
        "status.config_export_failed": "\u914d\u7f6e\u5bfc\u51fa\u5931\u8d25\uff1a{error}",
        "status.config_import_failed": "\u914d\u7f6e\u5bfc\u5165\u5931\u8d25\uff1a{error}",
        "status.config_import_wrong_zip": "这个 zip 不是个人配置包。请选择旧电脑从 Mouser 导出的 Mouser-settings-*.zip，不要选 GitHub 下载的程序包。",
        "status.config_folder_missing": "\u65e0\u6cd5\u6253\u5f00\u914d\u7f6e\u6587\u4ef6\u5939",
        "dialog.export_config": "导出 Mouser 个人配置包",
        "dialog.import_config": "导入 Mouser 个人配置包",
        "dialog.config_backup_filter": "Mouser 个人配置包 (*.zip);;旧版 JSON 配置 (*.json)",
        "dialog.config_restore_filter": "Mouser 个人配置包 (*.zip *.json)",
    },
    "zh_TW": {
        "scroll.config_backup": "\u8a2d\u5b9a\u5099\u4efd",
        "scroll.config_backup_desc": "用來備份你的快速鍵、設定檔、動作環、語言和其他個人設定。這個包和 GitHub 下載的程式 zip 不是同一個東西。",
        "scroll.config_backup_steps": "換電腦/重裝：舊電腦點「匯出個人設定包」，保存 Mouser-settings-*.zip；新電腦點「匯入個人設定包」，選擇這個匯出的 zip。",
        "scroll.config_export": "匯出個人設定包",
        "scroll.config_import": "匯入個人設定包",
        "scroll.config_open_folder": "開啟本機設定資料夾",
        "status.config_exported": "個人設定包已匯出：{path}。換電腦時，在新電腦的 Mouser 裡匯入這個 Mouser-settings zip。",
        "status.config_imported": "個人設定已匯入，快速鍵已還原",
        "status.config_export_failed": "\u8a2d\u5b9a\u532f\u51fa\u5931\u6557\uff1a{error}",
        "status.config_import_failed": "\u8a2d\u5b9a\u532f\u5165\u5931\u6557\uff1a{error}",
        "status.config_import_wrong_zip": "這個 zip 不是個人設定包。請選擇舊電腦從 Mouser 匯出的 Mouser-settings-*.zip，不要選 GitHub 下載的程式包。",
        "status.config_folder_missing": "\u7121\u6cd5\u958b\u555f\u8a2d\u5b9a\u8cc7\u6599\u593e",
        "dialog.export_config": "匯出 Mouser 個人設定包",
        "dialog.import_config": "匯入 Mouser 個人設定包",
        "dialog.config_backup_filter": "Mouser 個人設定包 (*.zip);;舊版 JSON 設定 (*.json)",
        "dialog.config_restore_filter": "Mouser 個人設定包 (*.zip *.json)",
    },
}
