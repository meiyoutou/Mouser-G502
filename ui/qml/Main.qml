        ...
        Rectangle {
            ...
            Item {
                ...
                Column {
                    ...
                    Repeater {
                        ...
                        delegate: FocusScope {
                            ...
                            Accessible.description: (lm.strings["accessibility.open_named"] || "Open {name}")
                                .replace("{name}", lm.strings[modelData.tipKey] || modelData.tipKey)
                ...
                FocusScope {
                    ...
                    Accessible.description: (lm.strings["accessibility.open_named"] || "Open {name}")
                        .replace("{name}", lm.strings["nav.about"] || "About")
