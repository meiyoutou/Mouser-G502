...
RING_LABEL_TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh_CN": {
        ...
        "cycle_dpi": "切换 DPI",
        "toggle_smart_shift": "SmartShift",
        "switch_scroll_mode": "滚轮模式",
        "activate_actions_ring": "动作环",
        "mouse_left_click": "左键",
        "mouse_right_click": "右键",
        "mouse_middle_click": "中键",
        "mouse_back_click": "后退",
        "mouse_forward_click": "前进",
        "none": "无",
        "cycle_desktops": "切换桌面",
        "zoom_in": "放大",
        "zoom_out": "缩小",
    ...
    "zh_TW": {
        "mission_control": "任務控制",
        "app_expose": "應用視窗",
        "show_desktop": "顯示桌面",
        "launchpad": "啟動台",
        "task_view": "工作檢視",
        "win_d": "顯示桌面",
        "screenshot_region_clip": "截圖",
        "play_pause": "播放/暫停",
        "next_track": "下一首",
        "prev_track": "上一首",
        "volume_up": "音量+",
        ...
        "cycle_dpi": "切換 DPI",
        "toggle_smart_shift": "SmartShift",
        "switch_scroll_mode": "滾輪模式",
        "activate_actions_ring": "動作環",
        "mouse_left_click": "左鍵",
        "mouse_right_click": "右鍵",
        "mouse_middle_click": "中鍵",
        "mouse_back_click": "後退",
        "mouse_forward_click": "前進",
        "none": "無",
        "cycle_desktops": "切換桌面",
        "zoom_in": "放大",
        "zoom_out": "縮小",
...
def _resolve_ring_label(action_id: str, full_label: str, language: str = "en") -> str:
    translated = RING_LABEL_TRANSLATIONS.get(language, {}).get(action_id)
    if translated:
        return translated
